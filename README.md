...
- [ ] Animated brand name entrance (OuiOui-style)
...
## Pricing (Designer Reference)

| Phase | Scope | Estimated Range |
|-------|-------|-----------------|
| Phase 1 | Landing page + email pipeline | $800 – $1,200 |
| Phase 2 | Event registration + Stripe + toggle | $1,500 – $2,500 |
| Phase 3 | Product pages (varies by catalog size) | $1,000 – $2,000 |
| Phase 4 | Full media platform | $3,000 – $6,000+ |
| **Total Potential** | | **$6,300 – $11,700+** |

Structure Phase 1 as a fixed-price contract. Scope each subsequent phase as a separate statement of work.

---

## Key Design Principles for Phase 1

1. **Bold entrance** — The 4TP brand name or logo should animate in on load, similar to how OuiOui's name appears on entry
2. **Email capture is the CTA** — Everything on the landing page serves the email signup, like ComplexCon
3. **Yellow + Black** — The brand's signature palette should dominate
4. **Inter typeface** — Clean, heavy weight for headlines, lighter for body
5. **Abstract and interactive** — Not a standard template; motion, blended transitions, and creative layout
6. **Mobile-first responsive** — Must look great on all screens

---

## Resources & Links

- Milanote Design Board: https://app.milanote.com/1W2Yp41EtzNset/website-reference
