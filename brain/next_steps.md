...
- [ ] Confirm the **new flow** matches client: cinematic gate (no full-screen fade per question) + docked yellow-square logo orientation → in-place granted overlay + brief static → logo → **yellow hero signup**.
- [ ] Validate question copy + choices against Milanote in production: Q1–Q3 Yes/No, Q4 Keep It/Share It (Share It treated as yes).
